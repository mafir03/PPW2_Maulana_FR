        ...
        <div class="container">
            ...
            <form method="post" action="{{ route('buku.update', $buku->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Penulis buku" value="{{$buku->penulis}}">
                </div>
                <div class="form-group">
                    <label for="harga">Harga</label>
                    <input type="text" class="form-control" id="harga" name="harga" placeholder="Harga buku" value="{{$buku->harga}}">
                </div>
                <div class="form-group">
                    <label for="tgl_terbit">Tgl. Terbit</label>
                    <input type="date" class="form-control" id="tgl_terbit" name="tgl_terbit" placeholder="Tgl. Terbit buku" value="{{$buku->tgl_terbit}}">
                </div>
                <div class="mt-2">
                    <div>File Name</div>
                ...
                <div class="container row">
                    @foreach($buku->galleries()->get() as $gallery)
                        <div class="col h-25 w-25 mt-2 mb-4">
                            <div align="center">
